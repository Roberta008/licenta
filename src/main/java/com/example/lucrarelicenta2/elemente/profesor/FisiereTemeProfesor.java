...
public class FisiereTemeProfesor extends VBox {
    ...
    public FisiereTemeProfesor(long idFisier, long idTema, long idCapitol, long idUtilizator,
            String numeFisier, InputStream continutFisier) {
        super();
    ...
    private void adaugaTooltip() {
        Tooltip tooltipFisier = new Tooltip("Apasa click pentru a descarca fisierul trimis de Student");
